...
switch (action.type) {
   ...
   case FILTER_TEMPERAMENT:
       ...
       const filtered = action.payload === 'temperament'? alltemperament : alltemperament.filter((e) => e.temperament?.includes(action.payload))
       return{
          ...state,
           dogs:filtered
       }
   case FILTER_CREATED:
       ...
       return{
           ...state,
           dogs: action.payload === 'all'? state.allDog: createdFilter
       }
   case FILTER_RAZA:
